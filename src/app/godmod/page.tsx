  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <StatCard label="Stories" value={totalItems} />
        <StatCard label="Comments" value={totalComments} />
        <StatCard label="Shadow Banned" value={shadowBannedUsers} />
      </div>
              ...
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    by {item.author.username} • {item.points} points • {item.commentCount} comments
                  </p>
                </div>
